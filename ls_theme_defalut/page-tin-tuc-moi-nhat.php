<?php
/*
 * Template Name: Trang tin tức làm đẹp
 *
 * @package ls_theme
 */
get_header();
            ...
            <div class="beautify row">
                <div class="beautify-program col-lg-9 col-md-9">
                    <div class="beautify-program-list row">
                        <?php
                        $event_tip_beauty = get_term('55','tip_beauty_cat');
                        $args = array(
                            ...
                            'tax_query' => array(
                                array(
                                    'taxonomy' => 'tip_beauty_cat', //double check your taxonomy name in you dd
                                    'field'    => 'term_id',
                                    'terms'    => array( $event_tip_beauty->term_id ),
                                ),
                            ),
                        );
