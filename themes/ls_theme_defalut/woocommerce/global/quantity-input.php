...
if ( $max_value && $min_value === $max_value ) {
    ...
    ?>
    <div class="quantity product-briefing-right__amount--number d-flex">
        <label class="screen-reader-text" for="<?php echo esc_attr( $input_id ); ?>"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></label>
        <div class="quantity-button minus product-briefing-right__amount--number-delete border-1"><span>-</span></div>
        ...
        <div class="quantity-button plus product-briefing-right__amount--number-add border-1"><span>+</span></div>
    </div>
    <?php
}
